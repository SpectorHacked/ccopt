...
export const MODEL_FAMILIES: Record<ModelFamily, { match: RegExp; tiers: ModelTier[] }> = {
  anthropic: {
    ...
    tiers: [
      ...
      { key: 'sonnet', match: /sonnet/i, openrouter: 'anthropic/claude-sonnet-4.8' },
  ...
  openai: {
    ...
    tiers: [
      { key: 'large', match: /gpt-5(?!-?(mini|nano))|gpt-4o(?!-?mini)|gpt-4\.1(?!-?(mini|nano))/i, openrouter: 'openai/gpt-5' },
      { key: 'mini', match: /mini/i, openrouter: 'openai/gpt-5-mini' },
      { key: 'nano', match: /nano/i, openrouter: 'openai/gpt-5-nano' },
    ],
  },
  google: {
